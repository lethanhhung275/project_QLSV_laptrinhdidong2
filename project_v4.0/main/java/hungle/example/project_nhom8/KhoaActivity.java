...
public class KhoaActivity extends AppCompatActivity
    ...
    public void setEvent() {
        ...
        listView2.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                // lay danh sach sinh vien cua khoa
                timKiemSVKhoa(data.get(position).getMaKhoa());
                if (dataSV.isEmpty()){
                    ...
                    builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DeleteKhoa(data.get(position).getMaKhoa());
                        }
                    });
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(KhoaActivity.this);
                    builder.setTitle("Thông báo");
                    builder.setMessage("Không thể xóa khoa do có sinh viên trong khoa. Bạn vui lòng kiểm tra lại.");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_trangchu) {
            ...
            Intent intent = new Intent(KhoaActivity.this, TimKiemActivity.class);
            startActivity(intent);
        }
