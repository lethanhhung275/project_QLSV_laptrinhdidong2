...
public class TimSVKhoaActivity extends AppCompatActivity {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (int i = 0; i < dataKhoa.size(); i++){
                    if(dataKhoa.get(i).getTenKhoa().equals(tenKhoa)){
                        ...
                        if(data.isEmpty()){
                            Toast.makeText(TimSVKhoaActivity.this, "Khoa chưa có sinh viên", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    }
                }
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        DeleteSV(sv.getMaSV(), spinnerKhoa.getSelectedItem().toString());
                    }
                });
    ...
    public void DeleteSV(String sMa, String k)
    {
        Database db = new Database(this);
        data.clear();
        db.deleteSV(sMa);
