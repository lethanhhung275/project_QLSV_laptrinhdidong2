...
public class ChiTietSVActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_trangchu) {
            Intent intent = new Intent(ChiTietSVActivity.this, MainActivity.class);
            ...
            Intent intent = new Intent(ChiTietSVActivity.this, KhoaActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_sinhvien) {
            Intent intent = new Intent(ChiTietSVActivity.this, SinhVienActivity.class);
            startActivity(intent);
        }else if (id == R.id.nav_timkiem) {
            Intent intent = new Intent(ChiTietSVActivity.this, TimKiemActivity.class);
            startActivity(intent);
        }
