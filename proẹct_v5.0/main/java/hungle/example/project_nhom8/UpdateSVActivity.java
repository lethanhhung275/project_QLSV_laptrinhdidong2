...
public class UpdateSVActivity extends AppCompatActivity {
    ...
    public void setControl(){
        ...
        btnLuu = (Button) findViewById(R.id.btnLuuUpdateSV);
    }
        ...
        btnLuu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (inputLayoutTenSV.getEditText().getText().length() != 0 &&
                    ...
                    // kiem nam vao nam sinh
                    if(iNamSinh > Integer.parseInt(editTextNamVao.getText().toString())){
                        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateSVActivity.this) ;
                        builder.setTitle("Thông báo!!!")  ;
                        builder.setMessage("Năm sinh không hợp lệ. Vui lòng kiểm tra lại?");
